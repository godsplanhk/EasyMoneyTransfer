                ...
                <div className="px-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <button onClick={()=>{
                            ...
                            navigate("/dashboard");
                        }} className="justify-center rounded-md hover:bg-green-600 text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-400 text-black">
                            Initiate Transfer
                        </button>
                    </div>
                </div>
